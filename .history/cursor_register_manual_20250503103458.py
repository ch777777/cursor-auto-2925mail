...
def setup_email(translator=None):
    ...
    try:
        # 获取用户输入
        print(f"{Fore.CYAN}{EMOJI['INFO']} 请输入注册信息：{Style.RESET_ALL}")
        base_email_name = input(f"{Fore.CYAN}邮箱名 (字母+数字): {Style.RESET_ALL}")
        ...
        password = input(f"{Fore.CYAN}密码 (6~16个字符): {Style.RESET_ALL}")
        phone = input(f"{Fore.CYAN}手机号码: {Style.RESET_ALL}")
        ...
        print(f"{Fore.GREEN}2925邮箱地址: {base_email_name}@2925.com{Style.RESET_ALL}")
        print(f"{Fore.GREEN}Cursor使用的邮箱地址: {cursor_email_name}@2925.com{Style.RESET_ALL}")
        print(f"{Fore.GREEN}密码: {password}{Style.RESET_ALL}")
        
        # 保存账号信息到文件
        with open("2925_accounts.txt", "a", encoding="utf-8") as f:
            f.write(f"2925邮箱: {base_email_name}@2925.com\n")
            f.write(f"Cursor邮箱: {cursor_email_name}@2925.com\n")
...
class CursorRegistration:
    ...
    def setup_email(self):
        """Verify 2925.com email account"""
        try:
            # 获取用户输入
            print(f"{Fore.CYAN}{EMOJI['INFO']} 请输入2925邮箱信息：{Style.RESET_ALL}")
            base_email_name = input(f"{Fore.CYAN}邮箱名 (不需要输入@2925.com): {Style.RESET_ALL}")
            password = input(f"{Fore.CYAN}密码: {Style.RESET_ALL}")
            ...
            try:
                ...
                print(f"{Fore.CYAN}{EMOJI['INFO']} 账号信息已保存到 cursor_accounts.txt{Style.RESET_ALL}")
