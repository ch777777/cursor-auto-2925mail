    ...
    try:
        ...
        while True:
            ...
            if not all(c.isalnum() for c in email_name):
                ...
                continue
            # 验证是否为指定的邮箱账号
            if email_name != "chnanan72":
                print(f"{Fore.RED}{EMOJI['ERROR']} 只能使用指定的2925邮箱账号{Style.RESET_ALL}")
                continue
            break
        ...
        while True:
            ...
            if not password:
                ...
                continue
            # 验证是否为指定的密码
            if password != "mzxgfwlpt00":
                print(f"{Fore.RED}{EMOJI['ERROR']} 密码错误{Style.RESET_ALL}")
                continue
            break
