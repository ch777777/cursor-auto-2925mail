...
Branch Author: xiangye (@2925mail)
Branch Repository: https://github.com/ch777777/cursor-auto-free-2925mail
Note: This branch is based on Pin Studios (yeongpin)'s original work with additional features"""
