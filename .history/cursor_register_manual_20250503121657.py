...
def setup_email(translator=None):
    ...
    try:
        ...
        if submit_button:
            ...
            try:
                # 检查错误提示
                error_tips = page.eles("css:.el-message--error")
                if error_tips:
                    for tip in error_tips:
                        print(f"{Fore.RED}{EMOJI['ERROR']} 错误提示: {tip.text}{Style.RESET_ALL}")
                    return False
                
                # 检查成功提示
                success_tips = page.eles("css:.el-message--success")
                if success_tips:
                    for tip in success_tips:
                        print(f"{Fore.GREEN}{EMOJI['SUCCESS']} 成功提示: {tip.text}{Style.RESET_ALL}")
                
                # 检查警告提示
                warning_tips = page.eles("css:.el-message--warning")
                if warning_tips:
                    for tip in warning_tips:
                        print(f"{Fore.YELLOW}{EMOJI['WARN']} 警告提示: {tip.text}{Style.RESET_ALL}")
                
                # 检查表单验证提示
                form_tips = page.eles("css:.el-form-item__error")
                if form_tips:
                    for tip in form_tips:
                        print(f"{Fore.RED}{EMOJI['ERROR']} 表单错误: {tip.text}{Style.RESET_ALL}")
                    return False
                
            except Exception as e:
                print(f"{Fore.YELLOW}{EMOJI['WARN']} 检查提示信息时出错: {str(e)}{Style.RESET_ALL}")
        ...
        if login_button:
            ...
            try:
                ...
                if error_tips:
                    for tip in error_tips:
                        print(f"{Fore.RED}{EMOJI['ERROR']} 登录错误: {tip.text}{Style.RESET_ALL}")
                    return False
                ...
                if success_tips:
                    for tip in success_tips:
                        print(f"{Fore.GREEN}{EMOJI['SUCCESS']} 登录提示: {tip.text}{Style.RESET_ALL}")
                
            except Exception as e:
                print(f"{Fore.YELLOW}{EMOJI['WARN']} 检查登录提示信息时出错: {str(e)}{Style.RESET_ALL}")
