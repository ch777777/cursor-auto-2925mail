...
def setup_email(translator=None):
    ...
    try:
        ...
        # 组合邮箱名
        email_name = f"{base_email_name}{random_number}"
        print(f"{Fore.CYAN}{EMOJI['INFO']} 最终邮箱名: {email_name}{Style.RESET_ALL}")
...
class CursorRegistration:
    ...
    def setup_email(self):
        ...
        try:
            ...
            # 设置邮箱地址用于后续注册
            self.email_address = f"{email_name}@2925.com"
            return True
