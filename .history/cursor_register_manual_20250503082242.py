...
class CursorRegistration:
    ...
    def get_verification_code(self):
        ...
        try:
            ...
            # 勾选用户协议
            checkboxes = verification_page.eles(".iCheck-helper")
            ...
            for attempt in range(max_attempts):
                # 查找"刚刚"时间的邮件
                recent_emails = verification_page.eles("@class=date-time-text")
                for email in recent_emails:
                    if email.text == "刚刚":
                        # 查找对应的验证邮件标题
                        title = email.parent.parent.ele("@class=mail-content-title")
