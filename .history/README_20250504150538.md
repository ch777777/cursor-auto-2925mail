...
* Branch Author (@2925mail): xiangye
* Branch Repository: https://github.com/ch777777/cursor-auto-free-2925mail

This branch is based on Pin Studios (yeongpin)'s original work with additional features.
此分支基于 Pin Studios (yeongpin) 的原始工作开发，增加了额外功能。
