...
def setup_email(translator=None):
    ...
    try:
        ...
        submit_button = None
        selectors = [
            "css:.btn-register-submit",
            "css:button.btn-register-submit",
            "css:.register-form button[type='submit']",
            "xpath://button[contains(@class, 'btn-register-submit')]",
            "xpath://button[contains(text(), '立即注册')]",
            "xpath://span[text()='立即注册']/parent::button"
        ]
