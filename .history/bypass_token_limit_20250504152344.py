    ...
    try:
        ...
        if os.name != "nt":  # Not Windows
            try:
                ...
                # Skip restoring ownership if os.chown is unavailable or fails
                print(f"{Fore.YELLOW}{EMOJI['WARNING']} Unable to restore file ownership{Style.RESET_ALL}")
